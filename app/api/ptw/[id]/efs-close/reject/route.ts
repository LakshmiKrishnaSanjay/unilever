...
export async function PATCH(
  ...
  try {
    ...
    const rejectedBy = body?.rejectedBy || 'EFS Engineer';
    ...
    const { error: updateError } = await supabase
      ...
      .update({
        ...
        sent_back_from_stage: 'PENDING_EFS_CLOSURE',
        timeline,
    ...
    return NextResponse.json({
      success: true,
      message: 'EFS closure rejected and returned to supervisor.',
    });
  } catch (error: any) {
    return NextResponse.json(
